    ...
    <div class=\"card-body\">
        ...
        echo "\" class=\"btn btn-sm btn-outline-secondary\">Edit</a>
            ...
            <small class=\"text-muted\">
                ";
        // line 19
        $context["reading_time"] = twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 19, $this->source); })()), "getReading_time", [], "method", false, false, false, 19);
        // line 20
        echo "                ";
        ((((isset($context["reading_time"]) || array_key_exists("reading_time", $context) ? $context["reading_time"] : (function () { throw new RuntimeError('Variable "reading_time" does not exist.', 20, $this->source); })()) == 0)) ? (print ("Less 1 min")) : (print (twig_escape_filter($this->env, ((isset($context["reading_time"]) || array_key_exists("reading_time", $context) ? $context["reading_time"] : (function () { throw new RuntimeError('Variable "reading_time" does not exist.', 20, $this->source); })()) . " mins"), "html", null, true))));
        echo "
            </small>
        </div>
    </div>
...
";
    ...
    {
        return array (  79 => 20,  77 => 19,  70 => 15,  66 => 14,  57 => 9,  55 => 8,  49 => 5,  44 => 3,  40 => 1,);
    }
...
<div class=\"card shadow-sm\">
    ...
    <div class=\"card-body\">
        ...
        <div class=\"d-flex justify-content-between align-items-center\">
            ...
            <small class=\"text-muted\">
                {% set reading_time = article.getReading_time() %}
                {{ reading_time == 0 ? 'Less 1 min' : reading_time ~ ' mins' }}
            </small>
        </div>
    </div>
</div>
