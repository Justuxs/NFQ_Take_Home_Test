    ...
    public function block_main($context, array $blocks = [])
    {
        ...
        echo "</h1>
                    <p class=\"text-muted\">
                        ";
        // line 10
        (((twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 10, $this->source); })()), "readingTime", [], "any", false, false, false, 10) == 0)) ? (print ("Less 1 min")) : (print (twig_escape_filter($this->env, ((isset($context["reading_time"]) || array_key_exists("reading_time", $context) ? $context["reading_time"] : (function () { throw new RuntimeError('Variable "reading_time" does not exist.', 10, $this->source); })()) . " mins"), "html", null, true))));
        echo "
                    </p>
                </div>
        ...
        // line 16
        echo twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 16, $this->source); })()), "text", [], "any", false, false, false, 16);
        echo "</div>
...
";
    ...
    {
        return array (  88 => 19,  82 => 16,  77 => 14,  70 => 10,  65 => 8,  59 => 4,  52 => 3,  35 => 1,);
    }
        ...
        <div class=\"py-5 bg-light\">
            <div class=\"container\">
                <div class=\"py-5 text-center\">
                    ...
                    <p class=\"text-muted\">
                        {{ article.readingTime == 0 ? 'Less 1 min' : reading_time ~ ' mins' }}
                    </p>
                </div>
